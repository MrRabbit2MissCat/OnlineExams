...
class Questions(models.Model):
    ...
    multi_brand_sales_department = models.CharField(db_column='multi-brand_sales_department', max_length=100, blank=True, null=True)  # Field renamed to remove unsuitable characters.
